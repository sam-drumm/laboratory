...
router.post('/', async (req, res) => {
  const { auth0Id, category, description, succcess, projectTitle, seeking, purpose, started, skillType, skillDescription } = req.body
  const project = { auth0Id, category, description, succcess, projectTitle, seeking, purpose, started, skillType, skillDescription }
